...
Rcpp::List threshold_detection_impl(const std::vector<int>& audio_samples, size_t sample_rate, size_t threshold, double min_d, double max_d, double TBE_min, double TBE_max, double EDG, size_t LPF, size_t HPF, double dur_t, double snr_t, double angl_t, size_t FFT_size, double FFT_overlap, double start_t, double end_t, const size_t NWS, double KPE, double KME);
RcppExport SEXP _bioacoustics_threshold_detection_impl(SEXP audio_samplesSEXP, SEXP sample_rateSEXP, SEXP thresholdSEXP, SEXP min_dSEXP, SEXP max_dSEXP, SEXP TBE_minSEXP, SEXP TBE_maxSEXP, SEXP EDGSEXP, SEXP LPFSEXP, SEXP HPFSEXP, SEXP dur_tSEXP, SEXP snr_tSEXP, SEXP angl_tSEXP, SEXP FFT_sizeSEXP, SEXP FFT_overlapSEXP, SEXP start_tSEXP, SEXP end_tSEXP, SEXP NWSSEXP, SEXP KPESEXP, SEXP KMESEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type TBE_min(TBE_minSEXP);
    Rcpp::traits::input_parameter< double >::type TBE_max(TBE_maxSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(threshold_detection_impl(audio_samples, sample_rate, threshold, min_d, max_d, TBE_min, TBE_max, EDG, LPF, HPF, dur_t, snr_t, angl_t, FFT_size, FFT_overlap, start_t, end_t, NWS, KPE, KME));
    return rcpp_result_gen;
END_RCPP
}
// blob_detection_impl
Rcpp::List blob_detection_impl(const std::vector<int>& audio_samples, size_t sample_rate, size_t FFT_size, double FFT_overlap, double TBE_min, double TBE_max, size_t HPF, size_t LPF, double min_d, double max_d, size_t area, double blur_f, double bg_substract, double EDG, double boost);
RcppExport SEXP _bioacoustics_blob_detection_impl(SEXP audio_samplesSEXP, SEXP sample_rateSEXP, SEXP FFT_sizeSEXP, SEXP FFT_overlapSEXP, SEXP TBE_minSEXP, SEXP TBE_maxSEXP, SEXP HPFSEXP, SEXP LPFSEXP, SEXP min_dSEXP, SEXP max_dSEXP, SEXP areaSEXP, SEXP blur_fSEXP, SEXP bg_substractSEXP, SEXP EDGSEXP, SEXP boostSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<int>& >::type audio_samples(audio_samplesSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(blob_detection_impl(audio_samples, sample_rate, FFT_size, FFT_overlap, TBE_min, TBE_max, HPF, LPF, min_d, max_d, area, blur_f, bg_substract, EDG, boost));
    return rcpp_result_gen;
END_RCPP
}
// read_wac_impl
